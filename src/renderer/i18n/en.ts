export const en = {
  ...
  'settings.showPaneStatus': 'Show console status overlay',
  'settings.showPaneStatusHint': 'A small state dot and runtime timer on each console header.',
  'settings.notifyOnDone': 'Notify when a task finishes',
  'settings.notifyOnDoneHint': 'For AI consoles only, when the app or workspace isn’t in view.',
