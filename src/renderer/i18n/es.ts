...
export const es: Record<keyof typeof en, string> = {
  ...
  'settings.showPaneStatus': 'Mostrar estado de la consola',
  'settings.showPaneStatusHint': 'Un punto de estado y un cronómetro en cada consola.',
  'settings.notifyOnDone': 'Avisar cuando termina una tarea',
  'settings.notifyOnDoneHint': 'Solo consolas de IA, cuando la app o el workspace no están a la vista.',
  ...
  'settings.notifyVolume': 'Volumen de la notificación',
