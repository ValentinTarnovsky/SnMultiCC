...
import { Activity, Bell, Bot, Info, Languages, Palette, Power, Search, TerminalSquare, type LucideIcon } from 'lucide-react'
...
const CATEGORIES: Category[] = [
  ...
  { id: 'notifications', labelKey: 'settings.cat.notifications', icon: Bell, keywords: ['notification', 'notificacion', 'notificación', 'alert', 'alerta', 'sound', 'sonido', 'status', 'estado', 'badge'] },
