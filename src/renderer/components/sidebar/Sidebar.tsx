    ...
    >
      ...
      <div className="px-2 pb-2">
        <Tooltip label={sidebarCollapsed ? t('sidebar.newWorkspace') : ''} side="right">
          <button
            onClick={onNew}
            className="flex w-full items-center gap-2 overflow-hidden rounded-btn border border-border bg-card px-[11px] py-2 text-sm text-text-primary transition-colors hover:border-accent-violet/40"
          >
